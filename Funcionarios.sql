...
select idFuncionario, nome, sexo, departamento from funcionarios where departamento = "Roupas" or departamento = "Filmes";

select nome, sexo, email, departamento from funcionarios where (departamento = "Lar" or departamento="Filmes") and sexo = "Feminino";
